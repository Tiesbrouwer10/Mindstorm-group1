...
void lineSeen(uint8_t insideMotor, uint8_t outsideMotor, float &Accelerator, BrickPi3 &BPLine); // Turning function
...
void objectDetection(BrickPi3 BPLine, unsigned int &objectTimer); // Check if object is within range
